...
There is a great deal of confusion in the ecological forecasting literature about the use of the terms 'forecasting' and 'prediction'. While this confusion is not surprising given the similarly inconsistent definitions in neighbouring fields, it nevertheless can cause problems.

I suspect that this confusion is a result of the differing definitions in neighboring fields.
...
The real difficulties come from the word prediction.

In other forecasting domains, these wrinkles have largely been ironed out.

I'm not attempting to resolve these differences, but simply to provide a guide which might help to navigate them.
